...
const std::string	Intern::names_[3] = {"shrubbery creation", "robotomy request", "presidential pardon"};
const AForm*		Intern::forms_[3] = {&Intern::newShrubberyCreation, &Intern::newRobotomyRequest, &Intern::newPresidentialPardon};
